...
`,O=m.default.div`
    ...
    padding: 0 .8125rem;
    max-width: 728px;
`;function $(){const[e,t]=a.useState(""),r=o(),n=()=>{var a;""!==e.trim()?(r((a=e,(e,t)=>{t().app.MyWS?.send(JSON.stringify({type:"CHAT",payload:{type:"MESSAGE_SENT",payload:{text:a}}}))})),t("")):t("")};return a.createElement(z,null,a.createElement(_,null,a.createElement(R,null,a.createElement(C,null,a.createElement(D,null,a.createElement(A,{value:e,onChange:e=>t(e.target.value),onKeyDown:e=>{!1===e.shiftKey&&"Enter"===e.key&&(e.preventDefault(),n())}}))))))}const z=m.default.div`
    width: 100%;
